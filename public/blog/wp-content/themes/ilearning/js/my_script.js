...
$("body").on("click",".ins_formVideos_footer a",function(){
   var html = '<div class="ins_formVideos_appended_row"><div class="ins_formVideos_row"><div class="ins_formVideos_cell ins_formVideos_cell1"><div class="form_field"> <input type="text" class="ins_formVideos_courseName_field"></div></div><div class="ins_formVideos_cell ins_formVideos_cell2"><div class="search_select_out"> <select class="search_select ins_formVideos_cat_sel"><option></option><option>Lorem Ipsum Dolor Site Amet</option><option>Lorem Ipsum has been the industry"s</option> </select></div></div><div class="ins_formVideos_cell ins_formVideos_cell3"><div class="form_field"> <input type="text" class="ins_formVideos_courseName_field"></div></div><div class="ins_formVideos_cell ins_formVideos_cell4"> <a href="javascript:void(0)" class="ins_formVideos_delete_icon ins_formVideos_delClick"></a></div></div></div>';
   $(this).closest(".ins_formVideos_main").find(".ins_formVideos_appendAble").append(html);
