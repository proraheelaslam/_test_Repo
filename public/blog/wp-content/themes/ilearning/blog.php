...
<main class="content">
	<section class="blog_main">
		...
		<div class="blog_slider_main gray_bg">
			<div class="auto_content">
				...
				<div class="blog_slider">
					...
					while ($query->have_posts()) {
						$query->the_post();
						$featured_post_short_text = get_field('featured_post_short_text');
						...
						<div>
							<div class="blog_slider_box">
								...
								<div class="blog_slider_text">
									<span><?php echo $featured_post_short_text; ?></span>
									<p><?php the_title() ?></p>
								</div>
								...
								<div class="cp_course_tags">
									...
									<ul>
										...
										<? if (!empty($posttags)) { ?>
											...
											?>
												<li><a href="<?php echo $tag_link; ?>"><? echo $tagdisplay = $this_tag->name; ?></a></li>
										<? }
										} ?>
									</ul>
								</div>
