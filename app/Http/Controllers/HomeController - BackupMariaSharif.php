...
class HomeController extends Controller
{
    ...
    public function  index(){
       ...
       /* $doctors              = Doctor::count();
        ...
        $onlineAppointments   = Appointment::where('appointment_type','online')->count();
        $clinicAppointments   = Appointment::where('appointment_type','clinic')->count();
        $totalSale            = CardOrder::sum('order_balance');
        $cards                = Card::count(); //Card::count();
        $cardsSold            = CardOrder::count();

        return  view('admin.home',compact('doctors','patients', 'cities', 'appointments', 'onlineAppointments',
            'clinicAppointments', 'totalSale', 'cards', 'cardsSold'));*/
    }
