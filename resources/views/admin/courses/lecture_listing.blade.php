 ...
 <!--main content start-->
    <section id="main-content">
        ...
        @include('admin/template/flash_messages')
         <div class="row">
           <div class="col-sm-6">
                 <a style="margin-bottom:10px;" class="btn btn-primary" href="<?=URL::to('/')?>/admin/courses/create_lecture/<?=$course_id?>">Add New</a>
           </div>
...
var delID = 0;
var datatable_url = "{{url('admin/get_courses_content_lecture')}}";
...
$(document).ready(function () {
    ...
    $("#btn-delete").click(function(e) {
        if(delID != 0){
            ...
            $.ajax({
                url: "{{URL::to('/')}}/{{$resource}}/delete_lecture/"+delID,
