   ...
   <div class="form-group ">
     ...
     <div class="form-group ">
	    {!! Form::label('class_code','Class Code', array('class' => 'control-label')) !!}
	    {!! Form::text('class_code',null,['class'=>'form-control','required' => 'required']) !!}                                   
	</div>


 <div class="form-group">
    {!! Form::submit(isset($classes) ? 'Update' : 'Save' ,['class'=>'btn btn-success pull-right']) !!}
</div>
