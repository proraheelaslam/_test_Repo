    ...
    <section id="main-content">
        ...
        @include('admin/template/flash_messages')
         <div class="row">
           <div class="col-sm-6">
           <?php 
		   $country_id_end = Hashids::encode($country_id);
		   ?>
                 <a style="margin-bottom:10px;" class="btn btn-primary" href="<?=URL::to('/')?>/admin/states/create_state/<?=$country_id_end?>">Add New</a>
           </div>
...
var delID = 0;
var datatable_url = "{{url('admin/get_states_all')}}";
