 ...
 <!--main content start-->
    <section id="main-content">
        ...
        @include('admin/template/flash_messages')
         <div class="row">
           <div class="col-sm-6">
                 <a style="margin-bottom:10px;" class="btn btn-primary" href="<?=URL::to('/')?>/admin/menu_category/create_menu_link/<?=$category_key?>">Add New</a>
           </div>
...
var delID = 0;
var datatable_url = "{{url('admin/get_menu_links_all').'/'.$category_key}}";
